...
public class DreamPinsActivity 
		extends FragmentActivity 
		implements MenuFragment.MenuEventListener {
	...
	public static String BACKUP_DIR = "imageDir";
	public static String BACKUP_FILE = "design.png";
	//////
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/////////////
		sync = SyncFactory.getSyncManger(this, BACKUP_DIR, BACKUP_FILE);
		sync.getZipZapData();
		/////////////
